...
public class NPC_Josephine extends Entity {
    ...
    public void getImage() {
        down1  = setup("/npc/josephine/josephine_down_1");
        down2  = setup("/npc/josephine/josephine_down_2");
        up1    = setup("/npc/josephine/josephine_up_1");
        up2    = setup("/npc/josephine/josephine_up_2");
        left1  = setup("/npc/josephine/josephine_left_1");
        left2  = setup("/npc/josephine/josephine_left_2");
        right1 = setup("/npc/josephine/josephine_right_1");
        right2 = setup("/npc/josephine/josephine_right_2");
    }
    ...
    public void speak() {
        ...
        if (stage == QuestManager.Q7_TALK_JOSEPHINE) {
            dialogues[0] = "Joe, please… look at me one last time.";
            ...
            dialogues[0] = "Be brave, Joe. The world will remember you.";
            dialogues[1] = null;
            dialogueIndex = 0;
            super.speak();
        }
